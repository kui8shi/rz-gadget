...
use rustproof_libsmt::theories::core::OpCodes::Cmp;
...
fn concretize(symexp: NodeIndex) -> u64{
    0
}
impl Memory for SegMem {
    ...
    fn read(&mut self, addr: NodeIndex, read_size: usize, solver: &mut SMTLib2<qf_abv::QF_ABV>) -> NodeIndex {
        ...
        println!("{}", solver.expand_assertion(result));
        result
    }
...
mod test {
    ...
    #[test]
    fn check_read() {
        use rustproof_libsmt::backends::smtlib2::{SMTLib2, SMTProc};
        use rustproof_libsmt::backends::backend::SMTBackend;
        use rustproof_libsmt::backends::z3::Z3;
        use rustproof_libsmt::theories::bitvec::OpCodes::Const;
        use rustproof_libsmt::theories::core::OpCodes::Cmp;
        use rustproof_libsmt::logics::qf_abv;
        use rzapi::structs::Endian;
